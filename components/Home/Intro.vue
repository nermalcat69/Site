<template>
  <div class="space-y-6">
    <NuxtImg src="/main/avatar.webp" alt="nermalcat69" draggable="false"
      ...
      sizes="48px sm:64px" format="webp" />
    <h1 class="text-xl font-bold tracking-tight text-gray-800 dark:text-gray-100">
      Arjun Aditya
    </h1>
    <span class="text-gray-500 dark:text-gray-500">Full Stack Engineer / Internet Alias: Nermal
    </span>
    ...
    <p class="text-gray-900 dark:text-gray-400">
      ...
      <a href="https://headshotpro.com" target="_blank" class="underline">Headshotpro</a>, and by night (and weekends),
      I'm busy tinkering with some random tool
