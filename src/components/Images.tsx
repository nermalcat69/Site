    ...
    return (
        <>
            ...
            <div className="flex justify-center px-4 sm:px-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-5 relative w-full sm:max-w-none sm:w-auto">
                    {images.map((image, index) => {
                        const dimensions = getImageDimensions(image.width, image.height);
                        return (
                            <div
                                key={index}
