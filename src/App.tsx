        ...
        <div className="mx-auto max-w-2xl py-16 px-6">
            ...
            <div className="py-16">
                ...
                <div className="section">
                    ...
                    <p className="txt font-thin">
                        Checkout my <a href="https://x.com/zNermo" target="_blank">Twitter</a>, <a href="https://github.com/nermalcat69" target="_blank">Github</a>, <a href="https://unsplash.com/@arjunaditya" target="_blank">Unsplash</a>, <a href="https://www.linkedin.com/in/nermalcat69" target="_blank">LinkedIn</a> and <a href="https://instagram.com/nermalcat69" target="_blank">Instagram</a>.
                    </p>
                </div>
                <SomeComponent />
            </div>
