        ...
        <div className="py-4 sm:py-6">
          <div className="section">
            ...
            <p className="txt text-sm sm:text-base">
              The point is, I enjoy almost everything from ui/ux design (despite
              being colorblind) to programming, marketing, writing, and
              finances.
            </p>
            <p className="txt text-sm sm:text-base">
              I started my programming journey in 2015 when I wanted to create
              my own version of Minecraft because that 90-minute free trial used
              to get on my nerves. Spent Some time in financial markets as well.
            </p>
            <p className="txt text-sm sm:text-base">
              ...
              , but I like to dabble in whatever comes my way.
            </p>
          </div>
          <div className="section">
            <p className="txt font-thin">
              Checkout my{" "}
              <a href="https://x.com/arjvnz" target="_blank">
                Twitter
              </a>
              ,{" "}
              <a href="https://github.com/nermalcat69" target="_blank">
                Github
              </a>{" "}
              and{" "}
              <a href="https://instagram.com/nermalcat69" target="_blank">
                Instagram
              </a>
              .
            </p>
